...
<!-- bespoke diagram: edit diagrams/system-architecture.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-sqlite/docs -->
...
<!-- bespoke diagram: edit diagrams/connection-lifecycle.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-sqlite/docs -->
...
<!-- bespoke diagram: edit diagrams/synchronous-query-model.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-sqlite/docs -->
...
<!-- bespoke diagram: edit diagrams/connection-settings-flow.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-sqlite/docs -->
...
<!-- bespoke diagram: edit diagrams/ddl-generation-flow.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-sqlite/docs -->
...
<!-- bespoke diagram: edit diagrams/connection-safety.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-sqlite/docs -->
...
<!-- bespoke diagram: edit diagrams/meadow-ecosystem-integration.mmd or .hints.json, then: npx pict-renderer-graph build modules/meadow/meadow-connection-sqlite/docs -->
